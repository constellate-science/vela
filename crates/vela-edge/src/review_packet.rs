...
use vela_protocol::evidence_ci::{self, EvidenceCiReport};
use crate::frontier_task::{self, FrontierTask};
use vela_protocol::scientific_diff::DiffPackReviewSummary;
...
fn packet_id(
    ...
    let hash = vela_protocol::canonical::sha256_canonical(&value)?;
