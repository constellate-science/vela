...
//!    (strength is [`crate::confidence`]; evidence polarity is
//!    [`crate::status_provenance`]; this is the third, orthogonal
...
//!
//! Verifier evidence (the harder gate) is [`crate::verifier_attachment`].
